...
internal class JooqCheckRepositoryTest {
    ...
    fun getCheckCountByStatus() {
        ...
        val check1 = repository.initializeCheck(CheckRequest(CheckKey("ABC-123"), siteId, "https://page1.url"))
        val check2 = repository.initializeCheck(CheckRequest(CheckKey("ABC-123"), siteId, "https://page2.url"))
        val check3 = repository.initializeCheck(CheckRequest(CheckKey("SEO-42"), siteId, "https://page1.url"))
        val check4 = repository.initializeCheck(CheckRequest(CheckKey("SEO-42"), siteId, "https://page2.url"))
        ...
        assertThat(repository.getLatestChecksCountByStatus(siteId, ResultStatus.PASSED)).isEqualTo(2)
        assertThat(repository.getLatestChecksCountByStatus(siteId, ResultStatus.FAILED)).isEqualTo(2)
    }
    ...
    fun getChecksByPage() {
        ...
        val check3 = repository.initializeCheck(CheckRequest(CheckKey("SEO-42"), siteId, "https://page1.url"))
        val check4 = repository.initializeCheck(CheckRequest(CheckKey("SEO-42"), siteId, "https://page2.url"))
        val check5 = repository.initializeCheck(CheckRequest(CheckKey("SEO-42"), siteId, "https://page1.url"))
        val check6 = repository.initializeCheck(CheckRequest(CheckKey("SEO-42"), siteId, "https://page2.url"))
        ...
        val pages = repository.getLatestChecksByPage(siteId, "https://page1.url")
        assertThat(pages).hasSize(2)

        val pages2 = repository.getLatestChecksByPage(siteId, "https://page2.url")
    ...
    fun getChecksSummaries() {
        ...
        val summaries = repository.getLatestChecksSummaries(siteId)
